...
.config(['$stateProvider', '$urlRouterProvider',function ($stateProvider,   $urlRouterProvider) {
  $stateProvider
    ...
    .state('contacts.list', {
      ...
      templateUrl: 'static/app/contacts/contacts.list.html'
    })
    ...
    .state('contacts.detail', {
      ...
      views: {
        ...
        '': {
          templateUrl: 'static/app/contacts/contacts.detail.html',
    ...
    .state('contacts.detail.item', {
      ...
      views: {
        ...
        '': {
          templateUrl: 'static/app/contacts/contacts.detail.item.html',
    ...
    .state('contacts.detail.item.edit', {
      views: {
        ...
        '@contacts.detail': {
          templateUrl: 'static/app/contacts/contacts.detail.item.edit.html',
          controller: ['$scope', '$stateParams', '$state', 'utils',
            function (  $scope,   $stateParams,   $state,   utils) {
              $scope.item = utils.findById($scope.contact.items, $stateParams.itemId);
              $scope.done = function () {
