angular.module('omniboard.ImageViewer', ['adf.provider'])
...
.config(function(dashboardProvider){
	...
	.widget('ImageViewer', {
		...
		templateUrl: 'ImageViewer/ImageViewer.tpl.html',
		edit: {
			templateUrl: 'ImageViewer/edit.tpl.html',
			reload: false,
			controller: 'ImageViewerEditCtrl'
		},
		
	});
})

.controller('ImageViewerCtrl', function($scope, config, es, $modal, $rootScope, DataModels, $stateParams, $sce, $http, $interval, pageLevelData){
...
.controller('ImageViewerEditCtrl', function($scope, es, $rootScope, DataModels, $stateParams){
