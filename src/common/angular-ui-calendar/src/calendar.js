...
angular.module('ui.calendar', [])
  ...
  .directive('uiCalendar', ['uiCalendarConfig', '$locale', function(uiCalendarConfig, $locale) {
    ...
    return {
      restrict: 'A',
      scope: {eventSources:'=ngModel',calendarWatchEvent: '&', incDate: '=', refresh: '='},
      ...
      link: function(scope, elm, attrs, controller) {
        ...
        // watch for calendar refresh request
        scope.$watch('refresh', function(newO,oldO){
          if(newO){
        ...
        scope.$watch('incDate', function(newO,oldO){
        ...
        scope.init = function(){
          ...
          if( typeof scope.incDate != 'undefined'){
            for(var i=0; i<scope.incDate;i++){
              scope.calendar.fullCalendar( 'next' );
            }
          }
        };
